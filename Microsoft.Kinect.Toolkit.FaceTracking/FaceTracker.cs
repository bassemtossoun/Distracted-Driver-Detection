...
//            System.Diagnostics.Debug.Write("Y: " + this.frame.Rotation.Y+"\n");
            ...
            {
                System.Diagnostics.Debug.Write("YOU'RE DISTRACTED RIGHT\n");
            }
            else if (this.frame.Rotation.Y == 0)
            {
                System.Diagnostics.Debug.Write("CANNOT DETECT FACE");
            }
            else if (this.frame.Rotation.Z < 1)
            {
                System.Diagnostics.Debug.Write("YOU'RE DISTRACTED UP\n");
            }
            else if (this.frame.Rotation.Z > 7)
            {
